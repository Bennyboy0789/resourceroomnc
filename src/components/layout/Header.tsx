      ...
      <Container size="wide" className="flex h-20 items-center justify-between gap-3 sm:gap-6">
        ...
        <div className="flex shrink-0 items-center gap-1.5 sm:gap-3">
          ...
          <button
            ...
            className="grid h-11 w-11 place-items-center rounded-chip border border-navy-950/15 text-navy-950 lg:hidden"
          >
              ...
              {group.slugs.map((slug) => {
                ...
                return (
                  <li key={slug} className="group/prog">
                    ...
                    >
                      <span className="relative h-12 w-12 shrink-0 overflow-hidden rounded-chip bg-navy-950/5">
                        <PhotoSlot
