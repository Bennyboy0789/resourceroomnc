...
export const posts: BlogPost[] = [
  {
    ...
    readingMinutes: 4,
    /*
     * The chart is square, but every slot this image fills crops: the 16:9
     * hero and featured card, the 4:3 grid and search cards, ~1.91:1 social
     * previews. So this is the chart centered on a matching 16:9 canvas at 92%
     * of its height, which keeps the headline and axis inside all of them. The
     * square original goes in the article body, where it is not cropped.
     */
    image: `/images/blog/august-2026-sat-results.png`,
...
<img src="/images/blog/august-2026-sat-results-chart.png" alt="Chart of 17 students, each shown as an arrow from their first practice test score to their official August 2026 SAT score. Every arrow points up, with gains from 50 to 370 points, and 13 of the 17 finish above the 1200 line." width="1400" height="1400" loading="lazy" decoding="async">
