...
export const posts: BlogPost[] = [
  {
    ...
    tags: [`ABA services`, `ADHD`, `anxiety in children`, `autism support`, `disability support`, `Holly Springs NC`, `IEP support`, `inclusive learning`, `neurodiverse learners`, `parent resources`, `Resource Room`, `special education`],
...
<a href="#">Talk With Our Team</a>`,
  },
  {
    ...
    tags: [`ACT`, `admissions strategy`, `college admissions`, `college planning`, `College Prep`, `high school juniors`, `high school seniors`, `merit scholarships`, `north carolina colleges`, `Resource Room`, `SAT`, `standardized testing`, `test prep`, `test-optional`, `unc chapel hill`, `unc system`],
...
<p>If you want help building a sensible testing plan for your student, one that fits their goals, their timeline, and the schools they are dreaming about, that is exactly the kind of thing we do at <strong>Resource Room</strong>. Come talk to us. Let&#8217;s make sure your student walks into this process holding every option they can.</p>`,
  },
  {
    ...
    tags: [`ABA therapy`, `Applied Behavior Analysis`, `autism`, `autism parenting`, `autism resources`, `autism support`, `behavior therapy`, `choosing an ABA provider`, `Holly Springs NC`, `neurodiverse students`, `neurodiversity`, `North Carolina`, `parent support`, `Pathways Academy`, `Resource Room`, `special education`],
...
<p><em>Resource Room is a complete and comprehensive learning center, offering numerous Pathways for students to find meaningful educational support. </em></p>`,
  },
  {
    ...
    date: `2024-03-18`,
    categories: [],
    tags: [`ACT`, `ACT test prep`, `Tutoring`, `SAT`, `STEAM`, `STEM`],
...
<p>Conquering the SAT&#8217;s Math and Reading sections can appear daunting, but with the right strategies and consistent practice, students can achieve their desired scores. Resource Room Learning Center is committed to providing exceptional educational experiences that help students reach their highest potential. With our personalized approach and expert strategies, students are well-equipped to master the SAT and open the doors to their future academic success. <a href="tel:(984) 777-1244">Contact us</a> today to<a href="https://resourceroomnc.com/request-a-consultation-form"> schedule an appointment</a> or to learn more about our tutoring services.</p>`,
  },
  {
    ...
    date: `2024-03-11`,
    categories: [`ACT/SAT Test Prep Resources`],
    tags: [`ACT`, `ACT test prep`, `SAT`, `STEM`, `Tutoring`],
...
<p>In conclusion, STEM education represents a paradigm shift in how we approach learning. It&#8217;s not just about acquiring knowledge; it&#8217;s about applying that knowledge in ways that matter. The transformational power of STEM education is a gateway to a future we can only begin to imagine. It&#8217;s about creating a world where learning is not just about passing exams, but about nurturing problem-solvers and innovators who will shape our world.</p>`,
  },
  {
    ...
    tags: [`ACT`, `ACT test prep`, `College`, `Global Careers`, `Language Clubs`, `Language Courses`, `Multilingualism`, `Tutoring`, `remote learning`, `SAT`, `SAT test prep`, `Second Language`, `STEAM`, `STEM`, `Study Abroad Programs`],
...
<p>Learning a second language in a college setting extends beyond the academic realm, contributing significantly to personal development. Embracing a new language is a transformative journey that enriches both the mind and the soul. Resource Room NC, with its diverse educational programs, provides a supportive environment for students looking to embark on this linguistic adventure. As students become proficient in a second language, they not only enhance their academic and career prospects but also contribute to a more interconnected and understanding global community.</p>`,
  },
  {
    ...
    date: `2024-01-26`,
    categories: [`ACT/SAT Test Prep Resources`, `STEAM Resources`, `Tutoring Resources`],
    tags: [`ACT`, `ACT test prep`, `Analytical Skills`, `Critical Thinking Skills`, `Informed Decision Making`, `Tutoring`, `Problem-Solving Skills`, `remote learning`, `SAT`, `SAT test prep`, `STEAM`, `STEM`],
...
<p>Cultivating critical thinking skills is fundamental to the educational process and prepares students for the challenges they&#8217;ll face in their academic and professional journeys. By integrating practical exercises and leveraging resources like private tutoring and STEAM programs, students can actively develop and enhance their critical thinking abilities. Resource Room NC stands as a supportive environment, offering tailored assistance to nurture the intellectual capabilities crucial for success in education and beyond. Through intentional efforts and the right educational support, students can cultivate a mindset that embraces critical thinking as an integral part of their learning journey.</p>`,
  },
  {
    ...
    tags: [`ACT`, `ACT test prep`, `Affordable College Education`, `Financial Aid`, `Tutoring`, `remote learning`, `SAT`, `SAT test prep`, `Scholarships`],
...
<p>For more information and guidance on scholarships and financial aid, visit<a href="https://resourceroomnc.com/"> Resource Room</a>.</p>`,
  },
  {
    ...
    date: `2023-12-15`,
    categories: [`Tutoring Resources`],
    tags: [`Tutoring`, `Standardized Tests`],
...
<p>For further guidance on academic success and college planning, visit<a href="https://resourceroomnc.com/"> Resource Room</a>.</p>`,
  },
  {
    ...
    tags: [`ACT`, `ACT test prep`, `Tutoring`, `remote learning`, `SAT`, `SAT test prep`],
...
<p>If you&#8217;re looking for the best SAT/ACT prep program, look no further than Resource Room.</p>`,
  },
  {
    ...
    date: `2023-05-12`,
    categories: [`Tutoring Resources`],
    tags: [`ACT test prep`, `Tutoring`, `remote learning`, `SAT test prep`, `STEAM`],
...
<p>Choosing the right tutoring program can make a big difference in your child&#8217;s academic success. At Resource Room, we offer a variety of tutoring programs to help students of all ages and abilities succeed. By considering your child&#8217;s specific needs, looking for qualified tutors, considering the format of the program, looking for a customized approach, and checking for flexibility, you can find the right tutoring program to meet your child&#8217;s needs.</p>`,
  },
  {
    ...
    date: `2023-05-05`,
    categories: [`Tutoring Resources`],
    tags: [`ACT`, `ACT test prep`, `Tutoring`, `SAT`, `SAT test prep`, `STEAM`],
...
<p>&#x200d;</p>`,
  },
  {
    ...
    date: `2021-10-03`,
    categories: [`ACT/SAT Test Prep Resources`, `Tutoring Resources`],
    tags: [`ACT`, `ACT test prep`, `SAT`, `SAT test prep`, `Tutoring`],
...
export const legacyTagPaths: { from: string; tag: string | null }[] = [
  { from: `/tag/aba-services`, tag: `ABA services` },
  { from: `/tag/aba-therapy`, tag: `ABA therapy` },
  { from: `/tag/act`, tag: `ACT` },
  { from: `/tag/act-test-prep`, tag: `ACT test prep` },
  { from: `/tag/adhd`, tag: `ADHD` },
  { from: `/tag/admissions-strategy`, tag: `admissions strategy` },
  { from: `/tag/affordable-college-education`, tag: `Affordable College Education` },
  { from: `/tag/alumni-network`, tag: null },
  { from: `/tag/analytical-skills`, tag: `Analytical Skills` },
  { from: `/tag/anxiety-in-children`, tag: `anxiety in children` },
  { from: `/tag/applied-behavior-analysis`, tag: `Applied Behavior Analysis` },
  { from: `/tag/autism`, tag: `autism` },
  { from: `/tag/autism-parenting`, tag: `autism parenting` },
  { from: `/tag/autism-resources`, tag: `autism resources` },
  { from: `/tag/autism-support`, tag: `autism support` },
  { from: `/tag/behavior-therapy`, tag: `behavior therapy` },
  { from: `/tag/career-opportunities`, tag: null },
  { from: `/tag/choosing-an-aba-provider`, tag: `choosing an ABA provider` },
  { from: `/tag/college`, tag: `College` },
  { from: `/tag/college-admissions`, tag: `college admissions` },
  { from: `/tag/college-essay-prep`, tag: null },
  { from: `/tag/college-planning`, tag: `college planning` },
  { from: `/tag/college-prep`, tag: `College Prep` },
  { from: `/tag/critical-thinking-skills`, tag: `Critical Thinking Skills` },
  { from: `/tag/disability-support`, tag: `disability support` },
  { from: `/tag/drones`, tag: `Drones` },
  { from: `/tag/effective-communication`, tag: null },
  { from: `/tag/financial-aid`, tag: `Financial Aid` },
  { from: `/tag/financial-independance`, tag: null },
  { from: `/tag/global-careers`, tag: `Global Careers` },
  { from: `/tag/high-school-juniors`, tag: `high school juniors` },
  { from: `/tag/high-school-seniors`, tag: `high school seniors` },
  { from: `/tag/holly-springs-nc`, tag: `Holly Springs NC` },
  ...
  { from: `/tag/iep-support`, tag: `IEP support` },
  { from: `/tag/inclusive-learning`, tag: `inclusive learning` },
  { from: `/tag/informed-decision-making`, tag: `Informed Decision Making` },
  { from: `/tag/language-clubs`, tag: `Language Clubs` },
  { from: `/tag/language-courses`, tag: `Language Courses` },
  { from: `/tag/merit-scholarships`, tag: `merit scholarships` },
  { from: `/tag/multilingualism`, tag: `Multilingualism` },
  { from: `/tag/networking`, tag: null },
  { from: `/tag/neurodiverse-learners`, tag: `neurodiverse learners` },
  { from: `/tag/neurodiverse-students`, tag: `neurodiverse students` },
  ...
  { from: `/tag/parent-support`, tag: `parent support` },
  ...
  { from: `/tag/problem-solving-skills`, tag: `Problem-Solving Skills` },
  ...
  { from: `/tag/sat-test-prep`, tag: `SAT test prep` },
  { from: `/tag/sat-test-pretp`, tag: null },
  { from: `/tag/scholarships`, tag: `Scholarships` },
  ...
  { from: `/tag/standardized-testing`, tag: `standardized testing` },
  { from: `/tag/standardized-tests`, tag: `Standardized Tests` },
  { from: `/tag/steam`, tag: `STEAM` },
  { from: `/tag/stem`, tag: `STEM` },
  { from: `/tag/student-mentorship`, tag: null },
  { from: `/tag/study-abroad`, tag: `Study Abroad` },
  { from: `/tag/study-abroad-programs`, tag: `Study Abroad Programs` },
  { from: `/tag/test-prep`, tag: `test prep` },
  { from: `/tag/test-optional`, tag: `test-optional` },
  { from: `/tag/time-management`, tag: null },
  { from: `/tag/tutor`, tag: `Tutoring` },
  { from: `/tag/tutoring`, tag: `Tutoring` },
  { from: `/tag/unc-chapel-hill`, tag: `unc chapel hill` },
  { from: `/tag/unc-system`, tag: `unc system` },
];
